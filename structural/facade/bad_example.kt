...
fun main() {
    ...
    val downloadMap = DownloadMap()
    val loadMap = LoadMap()
    val loadSoundTrack = LoadSoundTrack()
    val loadMods = LoadMods()
    val connectMultiplayerMode = ConnectMultiplayerMode()
    val turnOnOnlineMode = TurnOnOnlineMode()
    val gameStarter = GameStarter()

    var gameData = fileReader.read("game.exe")
    ...
    println("Game is ready: $gameData")
}
